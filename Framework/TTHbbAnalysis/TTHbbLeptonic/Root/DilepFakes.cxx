...
DilepFakes::DilepFakes(std::string params, std::shared_ptr<top::TopConfig> config) :
  ...
  esh->addVariableToBeSaved("isSubleadElChan", TTHbb::DecorationType::Char,false,"DilepFakes");
  esh->addVariableToBeSaved("isSubleadMuChan", TTHbb::DecorationType::Char,false,"DilepFakes");
