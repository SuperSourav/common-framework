...
BucketofTops::BucketofTops(std::vector<TLorentzVector> specbjets, std::vector<TLorentzVector> specnonbjets){
  ...
  Blist = bucketAlgo::doublebucket(specbjets, specnonbjets, bucketP1massMax, bucketP1massMin, "tw", firstP1Bucketwt);
  ...
  if (tmincand.size() == 2) {
    Blist = bucketAlgo::doublebucket(specbjets, specnonbjets, bucketP2massMax, bucketP2massMin, "t-", firstP2Bucketwt);
  }

  else if (tmincand.size() == 1){
    Blist[1-telseindex] = bucketAlgo::singlebucket(specbjets, specnonbjets, Blist[telseindex], bucketP2massMax, bucketP2massMin);
  }
