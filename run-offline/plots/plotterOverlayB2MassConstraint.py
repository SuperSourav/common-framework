...
def main():
  ...
  #process = {"ValidttbarAllhadISRjetsB1free_50K": "B2150GeV", "ValidttbarAllhadISRjetsB1exhaust_50K": "B2177GeV"}
  #process = {("ttbarNotAllhadB2150GeVB1wt%i"%b1wt) : "B2150GeV", ("ttbarNotAllhadB2177GeVB1wt%i"%b1wt) : "B2177GeV"}
  process = {("ttbarNotAllhadB2150GeVB1wt%i"%b1wt) : "B2150GeV", "blah" : "B2177GeV"}
  ...
  #bucket type count
  Stwcount = rnp.tree2array(tlist["B2150GeVtree"], branches="twcount")
  Stmincount = rnp.tree2array(tlist["B2150GeVtree"], branches="tmincount")
  St0count = rnp.tree2array(tlist["B2150GeVtree"], branches="t0count")

  ##
  SmW0 = rnp.tree2array(tlist["B2150GeVtree"], branches="mW0") 
  SmW1 = rnp.tree2array(tlist["B2150GeVtree"], branches="mW1")
  SmBucketPrim0 = rnp.tree2array(tlist["B2150GeVtree"], branches="mBucketPrim0")
  SmBucketPrim1 = rnp.tree2array(tlist["B2150GeVtree"], branches="mBucketPrim1")
  SmBucketPrim = np.concatenate((SmBucketPrim0,SmBucketPrim1), axis=None)
  Stwmass0  = rnp.tree2array(tlist["B2150GeVtree"], branches="twmass0")
  StwPt0  = rnp.tree2array(tlist["B2150GeVtree"], branches="twPt0")
  Stwmass1  = rnp.tree2array(tlist["B2150GeVtree"], branches="twmass1")
  StwPt1  = rnp.tree2array(tlist["B2150GeVtree"], branches="twPt1")
  SNaddjets  = rnp.tree2array(tlist["B2150GeVtree"], branches="Naddjets")

  #bucket type count
  Btwcount = rnp.tree2array(tlist["B2177GeVtree"], branches="twcount")
  Btmincount = rnp.tree2array(tlist["B2177GeVtree"], branches="tmincount")
  Bt0count = rnp.tree2array(tlist["B2177GeVtree"], branches="t0count")

  ##
  BmW0 = rnp.tree2array(tlist["B2177GeVtree"], branches="mW0") 
  BmW1 = rnp.tree2array(tlist["B2177GeVtree"], branches="mW1")
  BmBucketPrim0 = rnp.tree2array(tlist["B2177GeVtree"], branches="mBucketPrim0")
  BmBucketPrim1 = rnp.tree2array(tlist["B2177GeVtree"], branches="mBucketPrim1")
  BmBucketPrim = np.concatenate((BmBucketPrim0,BmBucketPrim1), axis=None)
  Btwmass0  = rnp.tree2array(tlist["B2177GeVtree"], branches="twmass0")
  BtwPt0  = rnp.tree2array(tlist["B2177GeVtree"], branches="twPt0")
  Btwmass1  = rnp.tree2array(tlist["B2177GeVtree"], branches="twmass1")
  BtwPt1  = rnp.tree2array(tlist["B2177GeVtree"], branches="twPt1")
  BNaddjets  = rnp.tree2array(tlist["B2177GeVtree"], branches="Naddjets")


  
  c0 = ROOT.TCanvas('c', 'c', 800, 600)
  leg0 = ROOT.TLegend( 0.65, 0.75, 0.88, 0.88)
  leg0.SetHeader("(B1 wt = %i)"%b1wt,"C")
  leg0.SetFillColor(0)
  leg0.SetLineColor(0)
  #bucket type count
  ShNaddjets = ROOT.TH1F("B2150GeV hNaddjets", "", 21, -0.5, 20.5)
  ...
  BhNaddjets = ROOT.TH1F("B2177GeV hNaddjets", "", 21, -0.5, 20.5)
  ...
  leg0.AddEntry(ShNaddjets, 'semileptonic B2', "L")
  BhNaddjets.Draw("hist same")
  leg0.AddEntry(BhNaddjets, 'hadronic B2', "L")
  leg0.Draw()
  c0.Print("OverlayhNaddjets_%sjetregion.eps"%njet)

  c1 = ROOT.TCanvas('c', 'c', 800, 600)
  leg1 = ROOT.TLegend( 0.65, 0.75, 0.88, 0.88)
  leg1.SetHeader("(B1 wt = %i)"%b1wt,"C")
  leg1.SetFillColor(0)
  leg1.SetLineColor(0)
  #bucket type count
  Shtwcount = ROOT.TH1F("B2150GeV htwcount", "", 4, -0.5, 3.5)
  ...
  Bhtwcount = ROOT.TH1F("B2177GeV htwcount", "", 4, -0.5, 3.5)
  ...
  Shtwcount.Draw("hist")
  leg1.AddEntry(Shtwcount, 'semileptonic B2', "L")
  Bhtwcount.Draw("hist same")
  leg1.AddEntry(Bhtwcount, 'hadronic B2', "L")
  leg1.Draw()
  c1.Print("Overlayhtwcount_%sjetregion.eps"%njet)

  c2 = ROOT.TCanvas('c', 'c', 800, 600)
  leg2 = ROOT.TLegend( 0.65, 0.75, 0.88, 0.88)
  leg2.SetHeader("(B1 wt = %i)"%b1wt,"C")
  leg2.SetFillColor(0)
  leg2.SetLineColor(0)
  #bucket type count
  ShmW0 = ROOT.TH1F("B2150GeV hmW0", "Mass of the (possible) W candidate in B1",150,0.0001,300)
  fill_hist(ShmW0, SmW0, "Mass (GeV)", "")
  ShmW0.Scale(1./(ShmW0.Integral()))
  ShmW0.SetLineColor(ROOT.kRed)
  BhmW0 = ROOT.TH1F("B2177GeV hmW0", "Mass of the (possible) W candidate in B1",150,0.0001,300)
  ...
  ShmW0.Draw("hist")
  leg2.AddEntry(ShmW0, 'semileptonic B2', "L")
  BhmW0.Draw("hist same")
  leg2.AddEntry(BhmW0, 'hadronic B2', "L")
  leg2.Draw()
  c2.Print("OverlayhmW0_%sjetregion.eps"%njet)

  c2p = ROOT.TCanvas('c', 'c', 800, 600)
  leg2p = ROOT.TLegend( 0.65, 0.75, 0.88, 0.88)
  leg2p.SetHeader("(B1 wt = %i)"%b1wt,"C")
  leg2p.SetFillColor(0)
  leg2p.SetLineColor(0)
  #bucket type count
  ShmW1 = ROOT.TH1F("B2150GeV hmW1", "Mass of the (possible) W candidate in B2",150,0.0001,300)
  fill_hist(ShmW1, SmW1, "Mass (GeV)", "")
  ShmW1.Scale(1./(ShmW1.Integral()))
  ShmW1.SetLineColor(ROOT.kRed)
  BhmW1 = ROOT.TH1F("B2177GeV hmW1", "Mass of the (possible) W candidate in B2",150,0.0001,300)
  ...
  ShmW1.Draw("hist")
  leg2p.AddEntry(ShmW1, 'semileptonic B2', "L")
  BhmW1.Draw("hist same")
  leg2p.AddEntry(BhmW1, 'hadronic B2', "L")
  leg2p.Draw()
  c2p.Print("OverlayhmW1_%sjetregion.eps"%njet)

  c3 = ROOT.TCanvas('c', 'c', 800, 600)
  leg3 = ROOT.TLegend( 0.65, 0.75, 0.88, 0.88)
  leg3.SetHeader("(B1 wt = %i)"%b1wt,"C")
  leg3.SetFillColor(0)
  leg3.SetLineColor(0)
  #bucket type count
  ShmBucketPrim0 = ROOT.TH1F("B2150GeV hmBucketPrim0", "Mass of B1",150,0,300);
  ...
  BhmBucketPrim0 = ROOT.TH1F("B2177GeV hmBucketPrim0", "Mass of B1",150,0,300);
  ...
  leg3.AddEntry(ShmBucketPrim0, 'semileptonic B2', "L")
  BhmBucketPrim0.Draw("hist same")
  leg3.AddEntry(BhmBucketPrim0, 'hadronic B2', "L")
  leg3.Draw()
  c3.Print("OverlayhmBucketPrim0_%sjetregion.eps"%njet)

  c4 = ROOT.TCanvas('c', 'c', 800, 600)
  leg4 = ROOT.TLegend( 0.65, 0.75, 0.88, 0.88)
  leg4.SetHeader("(B1 wt = %i)"%b1wt,"C")
  leg4.SetFillColor(0)
  leg4.SetLineColor(0)
  #bucket type count
  ShmBucketPrim1 = ROOT.TH1F("B2150GeV hmBucketPrim1", "Mass of B2",150,0,300);
  ...
  BhmBucketPrim1 = ROOT.TH1F("B2177GeV hmBucketPrim1", "Mass of B2",150,0,300);
  ...
  leg4.AddEntry(ShmBucketPrim1, 'semileptonic B2', "L")
  BhmBucketPrim1.Draw("hist same")
  leg4.AddEntry(BhmBucketPrim1, 'hadronic B2', "L")
  leg4.Draw()
  c4.Print("OverlayhmBucketPrim1_%sjetregion.eps"%njet)

  c7 = ROOT.TCanvas('c', 'c', 800, 600)
  leg7 = ROOT.TLegend( 0.65, 0.75, 0.88, 0.88)
  leg7.SetHeader("(B1 wt = %i)"%b1wt,"C")
  leg7.SetFillColor(0)
  leg7.SetLineColor(0)
  #bucket type count
  Shtwmass0 = ROOT.TH1F("B2150GeV htwmass0", "Mass of B1 tw",150,0.0001,300)
  ...
  Bhtwmass0 = ROOT.TH1F("B2177GeV htwmass0", "Mass of B1 tw",150,0.0001,300)
  ...
  Shtwmass0.Draw("hist")
  leg7.AddEntry(Shtwmass0, 'semileptonic B2 (%.f)'%S0Integral, "L")
  Bhtwmass0.Draw("hist same")
  leg7.AddEntry(Bhtwmass0, 'hadronic B2 (%.f)'%B0Integral, "L")
  leg7.Draw()
  c7.Print("Overlayhtwmass0_%sjetregion.eps"%njet)

  c7p = ROOT.TCanvas('c', 'c', 800, 600)
  leg7p = ROOT.TLegend( 0.65, 0.75, 0.88, 0.88)
  leg7p.SetHeader("(B1 wt = %i)"%b1wt,"C")
  leg7p.SetFillColor(0)
  leg7p.SetLineColor(0)
  #bucket type count
  Shtwmass1 = ROOT.TH1F("B2150GeV htwmass1", "Mass of B2 tw",150,0.0001,300)
  ...
  Bhtwmass1 = ROOT.TH1F("B2177GeV htwmass1", "Mass of B2 tw",150,0.0001,300)
  ...
  Shtwmass1.Draw("hist")
  leg7p.AddEntry(Shtwmass0, 'semileptonic B2 (%.f)'%S1Integral, "L")
  Bhtwmass1.Draw("hist same")
  leg7p.AddEntry(Bhtwmass1, 'hadronic B2 (%.f)'%B1Integral, "L")
  leg7p.Draw()
